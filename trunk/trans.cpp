		...
		if (mouse.button != 0)
		{
			...
			if (send.lclick(mouse.x,mouse.y))
				...
				if (strcmp(scanner.file,"check.xyz") == 0)
					spawnl(P_WAIT,"smartdog.exe",file,file,NULL);
